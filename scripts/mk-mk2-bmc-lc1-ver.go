...
var Images = [5]IMAGE{
	{"ubo", "src/u-boot", "platina-mk2-lc1-bmc-ubo.bin"},
	{"dtb", "src/linux", "platina-mk2-lc1-bmc.dtb"},
	{"env", ".", "platina-mk2-lc1-bmc-env.bin"},
	{"ker", "src/linux", "platina-mk2-lc1-bmc.vmlinuz"},
...
func getImageInfo(x int, nm string, di string, im string) {
	...
	t := time.Now()
	yr := t.Format("2006")
	ImgInfo[x].Name = "platina-mk2-lc1-bmc-" + nm + ".bin"
...
func writeVerFile(Release string) {
	...
	err := ioutil.WriteFile("platina-mk2-lc1-bmc-ver.bin", VerBlock, 0644)
	if err != nil {
